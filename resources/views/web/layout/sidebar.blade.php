<div class="hidden w-28 bg-slate-500 overflow-y-auto md:block">
    <div class="w-full py-6 flex flex-col items-center">
      <div class="flex-1 mt-2 w-full px-2 space-y-1">
        ...
        <a href="{{route('services.index')}}" class="{{ request()->routeIs('services.*') ? 'bg-slate-800 text-white' : 'text-indigo-100 hover:bg-slate-800 hover:text-white'}} group w-full p-3 rounded-md flex flex-col items-center text-xs font-medium">
            <svg xmlns="http://www.w3.org/2000/svg" class="{{request()->routeIs('services.*') ? 'bg-slate-800 text-white' : ' text-white'}} h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 10h16M4 14h16M4 18h16" />
              </svg>
            <span class="mt-2">Services</span>
        </a>

        <a href="{{route('ccs.index')}}" class="{{ request()->routeIs('ccs.*') ? 'bg-slate-800 text-white' : 'text-indigo-100 hover:bg-slate-800 hover:text-white'}} group w-full p-3 rounded-md flex flex-col items-center text-xs font-medium">
            <svg xmlns="http://www.w3.org/2000/svg" class="{{request()->routeIs('ccs.*') ? 'bg-slate-800 text-white' : ' text-white'}} h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 10h16M4 14h16M4 18h16" />
              </svg>
            <span class="mt-2">Customer cars</span>
        </a>

        <a href="{{route('orders.index')}}" class="{{ request()->routeIs('orders.*') ? 'bg-slate-800 text-white' : 'text-indigo-100 hover:bg-slate-800 hover:text-white'}} group w-full p-3 rounded-md flex flex-col items-center text-xs font-medium">
            <svg xmlns="http://www.w3.org/2000/svg" class="{{request()->routeIs('orders.*') ? 'bg-slate-800 text-white' : ' text-white'}} h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 10h16M4 14h16M4 18h16" />
              </svg>
